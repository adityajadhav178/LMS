...
function MyEnrollments() {
  ...
  const [progressArray, setProgressArray] = useState([
    {lecturesCompleted: 2 , totalLectures: 5},
  ...
  return (
    ...
    <div className='md:px-36 px-8 pt-10'>
      <h1 className='test-2xl font-semibold'>My Enrollments</h1>
              ...
              <tr key={index} className='border-b border-gray-500/20'>
                <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    <Line strokeWidth={2} percent={progressArray[index] && ((progressArray[index].lecturesCompleted / progressArray[index].totalLectures) * 100)} className='bg-gray-300 rounded-full'/>
                  </div>
                </td>
                ...
                <td className='px-4 py-3 max-sm:text-right'>
                  <button 
                    ...
                    {
                      progressArray[index] && 
                      (progressArray[index].lecturesCompleted / progressArray[index].totalLectures) === 1 ? "Completed" : "On Going"
                    }
                  </button>
                </td>
              </tr>
