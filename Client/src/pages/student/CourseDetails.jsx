...
function CourseDetails() {
  ...
  const fetchCourseData = async () => {
    ...
    console.log("Matched course: ", findCourse);
  ...
  return courseData ? (
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative item-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <p className="text-sm">
          Course by ,<span className="text-blue-600 underline">Teacher</span>
        </p>

        <div>
          <h2 className="text-xl font-semibold">Course Sructure</h2>
      ...
      <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]" >
        ...
        <div className="p-5">
          ...
          <div className="flex gap-3 items-center pt-2">
            ...
            <p>You save {courseData.discount}%</p>
          </div>
          ...
          <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
            ...
            <div className="flex items-center gap-1">
              <img src={assets.time_clock_icon} alt="clock time" />
            ...
            <div className="flex items-center gap-1">
              <img src={assets.lesson_icon} alt="lesson time" />
          ...
          <div className="pt-6">
            ...
            <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
              ...
              <li>Step-by-step, hands-on project guidencs.</li>
              <li>Downloadable resourses and sourse code</li>
